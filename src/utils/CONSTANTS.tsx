...
export const EventInfo = {
    ...
    bondsfotowedstrijd: {
        ...
        beschrijving: [
            "Dit is een wedstrijd voor de bij de Fotobond aangesloten clubs,",
            "die jaarlijks door één van die clubs georganiseerd wordt.",
            "",
            "Uiteraard doen wij hier als fotoclub ook aan mee, en soms met succes!",
            "Hieronder vind u de inzendingen van onze leden van de afgelopen jaren"
        ]
    }
}
